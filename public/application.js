...
/***/ function(module, exports, __webpack_require__) {
	...
	var blogEvents = __webpack_require__(12);
...
/***/ function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://guarded-mountain-32914.herokuapp.com'
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onIndexBlogs = function onIndexBlogs(event) {
	  event.preventDefault();
	  api.indexBlogs().then(ui.indexSuccess).catch(ui.onError);
	};

	var onIndexAllBlogs = function onIndexAllBlogs(event) {
	  event.preventDefault();
	  api.indexBlogs().then(ui.indexAllSuccess).catch(ui.onError);
	};

	var onIndexAllPublicBlogs = function onIndexAllPublicBlogs(event) {
	  event.preventDefault();
	  api.indexPublicBlogs().then(ui.indexAllPublicSuccess).catch(ui.onError);
	};
	...
	var onCreateBlogs = function onCreateBlogs(event) {
	  ...
	  var data = getFormFields(event.target);
	  console.log(data);
	  api.createBlog(data).then(ui.createSuccess).then(api.indexBlogs).then(ui.indexSuccess).catch(ui.failure);
	};
	...
	var onUpdateBlog = function onUpdateBlog(event) {
	  ...
	  api.updateBlog(id, data).then(ui.updateSuccess).then(api.indexBlogs).then(ui.indexSuccess).catch(ui.failure);
	};

	var onDestroyBlog = function onDestroyBlog(event) {
	  event.preventDefault();
	  var id = event.target.getAttribute('data-id');
	  api.destroyBlog(id).then(ui.destroySuccess).then(api.indexBlogs).then(ui.indexSuccess).catch(ui.failure);
	};

	var blogDropdownToggle = function blogDropdownToggle(event) {
	  $(event.target).toggleClass('glyphicon-menu-down');
	  $(event.target).toggleClass('glyphicon-menu-up');
	};

	var addBlogHandlers = function addBlogHandlers() {
	...
	module.exports = {
	  ...
	  onIndexBlogs: onIndexBlogs,
	  onUpdateBlog: onUpdateBlog,
	  addBlogHandlers: addBlogHandlers
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexPublicBlogs = function indexPublicBlogs() {
	  return $.ajax({
	    url: config.apiOrigin + '/blogs',
	    method: 'GET'
	  });
	...
	var updateBlog = function updateBlog(id, data) {
	  return $.ajax({
	...
	module.exports = {
	  ...
	  indexPublicBlogs: indexPublicBlogs,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var blogHandlebars = __webpack_require__(15);
	var allBlogHandlebars = __webpack_require__(35);

	var indexSuccess = function indexSuccess(data) {
	  data.blogs = data.blogs.reverse();
	  for (var i = 0; i < data.blogs.length; i++) {
	    var date = data.blogs[i].createdAt;
	    data.blogs[i].createdAt = date.slice(0, 10);
	  }

	  var blogsIndexHtml = blogHandlebars({
	    blogs: data.blogs
	  });
	...
	var indexAllSuccess = function indexAllSuccess(data) {
	  ...
	  var blogsIndexHtml = allBlogHandlebars({
	    blogs: data.blogs
	  });
	  $('#content-all-blogs').html(blogsIndexHtml);
	};

	var indexAllPublicSuccess = function indexAllPublicSuccess(data) {
	  data.blogs = data.blogs.reverse();
	  for (var i = 0; i < data.blogs.length; i++) {
	    var date = data.blogs[i].createdAt;
	    data.blogs[i].createdAt = date.slice(0, 10);
	...
	module.exports = {
	  ...
	  indexAllPublicSuccess: indexAllPublicSuccess,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<div data-id=\""
	    ...
	    + "\">\n  <!-- Are we going to display id? -->\n  <div class=\"handlebars-container\">\n    <h3 class=\"title\" id=\"blog-title-display\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "</h3>\n    <button class=\"btn btn-primary glyphicon glyphicon-menu-down\" id=\"dropdown-blog\" type=\"button\" data-toggle=\"collapse\" data-target=\"#collapseUpdate"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" aria-expanded=\"false\" aria-controls=\"collapseUpdate"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n</button>\n<div class=\"collapse update-collapse\" id=\"collapseUpdate"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n  <div class=\"well\">\n    <form class=\"blogs\" id=\"update-blog\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n      <div class=\"form-group\">\n        <label>Title\n        <input type=\"text\" name=\"blog[title]\" maxlength=\"150\" id=\"blog-title\" placeholder=\"Title\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "\">\n      </label>\n      <label>Author\n        <input type=\"text\" name=\"blog[author]\" maxlength=\"150\" id=\"blog-author\" placeholder=\"Author\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.author : stack1), depth0))
	    + "\">\n      </label>\n        <br>\n        <textarea rows=\"10\" cols=\"50\" id=\"blog-textarea\" maxlength=\"10000\" name=\"blog[content]\" placeholder=\"Content\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.content : stack1), depth0))
	    + "</textarea>\n      </div>\n      <button type=\"submit\" id=\"update-blog-btn\" class=\"btn btn-success glyphicon glyphicon-pencil\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Edit\"></button>\n    </form>\n    <button type=\"button\" id=\"delete-blog\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-danger glyphicon glyphicon-trash\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Delete\"></button>\n    <div id=\"clear-div\"></div>\n  </div>\n  </div>\n  <p class=\"author\" id=\"blog-author-display\">Written by: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.author : stack1), depth0))
	    + "</p>\n  <p class=\"date\">Date created: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.createdAt : stack1), depth0))
	    + "</p>\n    <p class=\"content\"><pre class=\"text-body\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.content : stack1), depth0))
	    + "</pre></p>\n\n\n  </div>\n\n</div>\n\n\n";
	  ...
	  return "\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.blogs : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onIndexPages = function onIndexPages(event) {
	  event.preventDefault();
	  api.indexPages().then(ui.indexSuccess).catch(ui.onError);
	};

	var onShowPage = function onShowPage(event) {
	  event.preventDefault();
	  var id = event.target.getAttribute('data-id');
	  api.showPage(id).then(ui.showSuccess).catch(ui.onError);
	};

	var onCreatePages = function onCreatePages(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  console.log(data);
	  api.createPage(data).then(ui.createSuccess).then(api.indexPages).then(ui.indexSuccess).catch(ui.failure);
	};

	var showAfterUpdate = function showAfterUpdate() {
	  var id = $('#update-page').data('id');
	  api.showPage(id).then(ui.showSuccess).catch(ui.failure);
	};
	...
	var onUpdatePage = function onUpdatePage(event) {
	  ...
	  var data = getFormFields(event.target);
	  var id = event.target.getAttribute('data-id');
	  api.updatePage(id, data).then(ui.updateSuccess).then(showAfterUpdate).catch(ui.failure);
	};

	var onDestroyPage = function onDestroyPage(event) {
	  event.preventDefault();
	  var id = event.target.getAttribute('data-id');
	  api.destroyPage(id).then(ui.destroySuccess).catch(ui.failure);
	};

	var pageDropdownToggle = function pageDropdownToggle(event) {
	  $(event.target).toggleClass('glyphicon-menu-down');
	  $(event.target).toggleClass('glyphicon-menu-up');
	};

	var addPageHandlers = function addPageHandlers() {
	...
	module.exports = {
	  addPageHandlers: addPageHandlers
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updatePage = function updatePage(id, data) {
	  return $.ajax({
	    url: config.apiOrigin + '/pages/' + id,
	    method: 'PATCH',
	    headers: {
	...
	var destroyPage = function destroyPage(id) {
	  return $.ajax({
	    url: config.apiOrigin + '/pages/' + id,
	    method: 'DELETE',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var pageTitleHandlebars = __webpack_require__(39);
	var pageShowHandlebars = __webpack_require__(40);

	var indexSuccess = function indexSuccess(data) {
	  var pagesIndexHtml = pageTitleHandlebars({
	    pages: data.pages
	  });
	...
	var showSuccess = function showSuccess(data) {
	  var pageShowHtml = pageShowHandlebars({
	    page: data.page
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<div data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n  <!-- Are we going to display id? -->\n  <div class=\"handlebars-container\">\n    <h3 class=\"header\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"><span id=\"page-header\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.header : stack1), depth0))
	    + "</span></h3>\n  </div>\n\n</div>\n\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.pages : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"useData":true,"useBlockParams":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<div data-id=\""
	    ...
	    + "\">\n  <!-- Are we going to display id? -->\n  <div class=\"handlebars-container\">\n    <pre class=\"text-body-page\"><h1 class=\"header\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.page : depth0)) != null ? stack1.header : stack1), depth0))
	    + "</h1>\n    <p class=\"body\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.page : depth0)) != null ? stack1.body : stack1), depth0))
	    + "</p>\n    <footer class=\"footer\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.page : depth0)) != null ? stack1.footer : stack1), depth0))
	    + "</footer></pre>\n    <button class=\"btn btn-primary glyphicon glyphicon-menu-down\" id=\"dropdown-page\" type=\"button\" data-toggle=\"collapse\" data-target=\"#collapseUpdate"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.page : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" aria-expanded=\"false\" aria-controls=\"collapseUpdate"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.page : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n</button>\n<div class=\"collapse\" id=\"collapseUpdate"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.page : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n  <div class=\"well\">\n    <form class=\"pages\" id=\"update-page\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.page : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n      <div class=\"form-group\">\n        <label>Header\n        <input type=\"text\" name=\"page[header]\" maxlength=\"300\" placeholder=\"Header\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.page : depth0)) != null ? stack1.header : stack1), depth0))
	    + "\">\n      </label>\n        <br>\n        <textarea rows=\"10\" cols=\"50\" maxlength=\"20000\" name=\"page[body]\" placeholder=\"Body\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.page : depth0)) != null ? stack1.body : stack1), depth0))
	    + "</textarea>\n        <br>\n        <label>Footer\n        <input type=\"text\" name=\"page[footer]\" maxlength=\"300\" placeholder=\"Footer\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.page : depth0)) != null ? stack1.footer : stack1), depth0))
	    + "\">\n      </label>\n      </div>\n      <button type=\"submit\" class=\"btn btn-success glyphicon glyphicon-pencil\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Edit\" id=\"update-page-btn\"></button>\n    </form>\n    <button type=\"button\" id=\"delete-page\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.page : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-danger glyphicon glyphicon-trash\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Delete\"></button>\n    <div id=\"clear-div\"></div>\n  </div>\n  </div>\n  </div>\n\n</div>\n";
	},"useData":true});
